...
function BackgroundCircles() {
  return (
    ...
    >
      <div className="absolute border border-[#0A81F7] rounded-full h-[200px] w-[200px] mt-52 animate-ping" />
      ...
      <div className="rounded-full border border-[#FF8C00] opacity-20 h-[650px] w-[650px] absolute mt-52 animate-pulse" />
